...
export class Backend implements backendInterface {
    ...
    async getAllEnquiries(): Promise<Array<Inquiry>> {
    ...
    async submitOrderInquiry(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitOrderInquiry(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
